...
xidplus.save([prior250],posterior,'data/fir/MIPS_no_lofar/xidplus_run_{}/lofar_xidplus_fir_{}_rerun.pkl'.format(taskid,taskid))
...
with serialize_method_as(MIPS_cat, None):
            registry.write(MIPS_cat,'data/fir/MIPS_no_lofar/xidplus_run_{}/lofar_xidplus_fir_{}_rerun.fits'.format(taskid,taskid),format='fits',overwrite=True)
