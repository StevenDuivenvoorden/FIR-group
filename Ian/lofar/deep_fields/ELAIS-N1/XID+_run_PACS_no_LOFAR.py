...
xidplus.save([prior100,prior160],posterior,'data/fir/PACS_no_lofar/xidplus_run_{}/lofar_xidplus_fir_{}_rerun.pkl'.format(taskid,taskid))
with serialize_method_as(PACS_cat, None):
            registry.write(PACS_cat,'data/fir/PACS_no_lofar/xidplus_run_{}/lofar_xidplus_fir_{}_rerun.fits'.format(taskid,taskid),format='fits',overwrite=True)
