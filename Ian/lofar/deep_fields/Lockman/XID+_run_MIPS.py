...
xidplus.save([prior250],posterior,'data/fir/v0_7/MIPS/xidplus_run_{}/lofar_xidplus_fir_{}'.format(taskid,taskid))
...
with serialize_method_as(MIPS_cat, None):
    registry.write(MIPS_cat,'data/fir/v0_7/MIPS/xidplus_run_{}/lofar_xidplus_fir_{}.fits'.format(taskid,taskid),format='fits',overwrite=True) 
#Table.write(MIPS_cat,'data/fir/v0_7/MIPS/xidplus_run_{}/lofar_xidplus_fir_{}_rerun.fits'.format(taskid,taskid),overwrite=True)
